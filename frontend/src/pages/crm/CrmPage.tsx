...
export const CrmPage: React.FC = () => {
  ...
  useEffect(() => {
    setPageInfo({
      title: 'CRM de Ofertas',
      subtitle: 'Control y seguimiento del pipeline comercial de dTS Instruments',
      icon: <Briefcase size={20} />,
      infoProps: {
        title: 'CRM de Ofertas',
        description: 'Permite a los comerciales ver su embudo de ventas, modificar estados, probabilidad, agendar tareas y registrar actividades.',
        objective: 'Incrementar la tasa de éxito de las ofertas y proporcionar pronósticos de ingresos fiables.',
  ...
  const updateQuoteMutation = useMutation({
    ...
    onSuccess: (_, variables) => {
      ...
      refetch();
      // Si la oferta modificada es la seleccionada actualmente, actualizamos su estado local
  ...
  // Calcular KPIs en base a ofertas visibles
  const kpis = useMemo(() => {
  ...
  const groupedQuotes = useMemo(() => {
    ...
    quotes.forEach(q => {
      ...
      if (groups[stage]) {
        ...
        groups['borrador'].push(q); // fallback
      }
    });
    return groups;
  }, [quotes]);
  ...
  const handleStageChange = (newStage: string) => {
    ...
    // Calcular probabilidad automática en base al estado
  ...
  // Check if a quote next action is overdue
                    ...
                    stageQuotes.map(quote => {
                      ...
                      return (
                        ...
                        >
                          ...
                          {/* Probability & Follow-up Action Alerts */}
          ...
          <div className="space-y-6 pb-12">
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                ...
                {/* Conditional Win/Loss Reason fields */}
            ...
            {/* Next Action Follow-up Planning */}
            <div className="space-y-4">
