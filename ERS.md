...
\* \*\*RF-02.1:\*\* El sistema debe incluir un panel global de filtros (rango de fechas, delegación/departamento si aplica) que actualice todos los gráficos en pantalla.  
\* \*\*RF-02.2:\*\* Las tablas de datos deben soportar paginación, ordenamiento por columnas y búsqueda de texto libre.
